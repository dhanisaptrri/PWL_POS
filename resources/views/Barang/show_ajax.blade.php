        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $barang->barang_satuan }}" type="text" name="barang_satuan" id="barang_satuan" class="form-control" disabled>
                    <small id="error-barang_satuan" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
